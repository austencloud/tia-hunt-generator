...
class FooterRenderer:
    ...
    def draw(self, x, y, total_items):
        ...
        self.canvas.setFont("DejaVuSans-Oblique", 11)
        ...
        footer_width = self.canvas.stringWidth(footer_text, "DejaVuSans-Oblique", 11)
        ...
        social_width = self.canvas.stringWidth(social_text, "DejaVuSans-Oblique", 11)
